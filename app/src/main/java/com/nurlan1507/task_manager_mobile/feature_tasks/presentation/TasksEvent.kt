...
sealed class TasksEvent {
    ...
    object TaskDragEvent:TasksEvent()
    data class AssignADraggableItem(val item:TaskWithProject, val date:Long):TasksEvent()
    object StartDragging:TasksEvent()
    object StopDragging:TasksEvent()
}