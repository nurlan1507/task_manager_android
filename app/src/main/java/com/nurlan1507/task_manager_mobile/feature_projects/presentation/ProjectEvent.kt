...
sealed class ProjectEvent {
    ...
    data class CreateProject(val project: Project):ProjectEvent()
     class CreateProjectNetwork:ProjectEvent()
    ...
    data class ProjecTitleEntered(val title:String):ProjectEvent()
    data class ProjectColorSelected(val color:ProjectColor):ProjectEvent()
}